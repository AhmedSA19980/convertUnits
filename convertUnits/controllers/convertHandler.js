function ConvertHandler() {
  ...
  this.getNum = function(input) {
    ...
    //* if we match  more then one fraction or decmeial => return undefeind
    if (nums.length > 2) {
      return undefined
    }
  ...
  this.convert = function(initNum, initUnit) {
    ...
    //result rounded to 5 decimals => 'tofixed' means get five digit decmials  
